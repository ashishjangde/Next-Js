...
const page = () => {
    ...
    return (
        <div className="relative flex justify-center items-center min-h-screen bg-gray-950/70 backdrop-blur-lg">
            <div className="absolute inset-0 bg-black/40 backdrop-blur-sm -z-10"></div> {/* Backdrop effect on all sides */}
